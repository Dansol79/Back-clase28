...
const chatEmailInput = document.querySelector('[name="email"]');
const chatNombreInput = document.querySelector('[name="nombre"]');
const chatApellidoInput = document.querySelector('[name="apellido"]');
const chatEdadInput = document.querySelector('[name="edad"]');
const chatAliasinput = document.querySelector('[name="alias"]');
const chatAvatarInput = document.querySelector('[name="avatar"]');
